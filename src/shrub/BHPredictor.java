...
/**
 * BHPredictor - prediction based on past history played backward.
 */
public class BHPredictor implements PredictorAPI
{
    ...
    // This is not a general predictor method, specific to BHPredictor.
...
//        System.out.println();
//        System.out.println("===== BHPredictor::Intercept(), startTime: " +
//                           startTime);
...
//        System.out.println("latest possible hit:   " + latestHit);
        ...
        while (okSoFar && !finished)
        {
            ...
            if (okSoFar == false)
            {
                System.out.println("BHPredictor, iterator gone bad");
            }
...
//                                   " being considered");
        ...
        {
//            System.out.println("VALID SOLUTION (BH): " +
//                               dp2.format(lastValidSpeed));
        ...
        {
//            System.out.println("ANGLE OVERRIDE (BH): " +
//                               dp2.format(bestAngleOverride));
          
            // Send back a request to turn turret with the idea
            // of having a valid solution next turn. Note: it is up to
