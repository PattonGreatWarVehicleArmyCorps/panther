...
public class osakaThree extends AdvancedRobot {

	Hashtable targets; // all enemies are stored in the hashtable
	EnemyOsaka target; // our current EnemyOsaka
	...
	/** Move the gun to the predicted next bearing of the EnemyOsaka **/
	void doGun() {
		long time = getTime()
				+ (int) Math
		...
		// targeting provided by the EnemyOsaka class
	...
	public void onScannedRobot(ScannedRobotEvent e) {
		...
		if (targets.containsKey(e.getName())) {
			en = (EnemyOsaka) targets.get(e.getName());
		} else {
			en = new EnemyOsaka();
	...
	public void onRobotDeath(RobotDeathEvent e) {
		EnemyOsaka en = (EnemyOsaka) targets.get(e.getName());
		en.live = false;
	}
}
...
class EnemyOsaka {
	...
	public boolean live; // is the EnemyOsaka alive?
